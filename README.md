...
> **⚠️ Nota:** Este projeto foi descontinuado no decorrer do seu desenvolvimento e "não viu a luz do dia", permanecendo como um registo de implementação técnica de algoritmos de exploração.
